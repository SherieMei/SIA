...
let idCounters = {p:3,a:11,v:12,c:3,n:4,e:4,au:4,w:1,api:0,r:3,u:8};
...
const DB = {
  ...
  apiLogs:[],
  resources:[
    {id:'r3',project:'p2',category:'Labor',desc:'Animator — spot revisions',cost:1600,hours:40},
  ],
};
...
pushNotif('revision','Revision requested on “Trailer — Theme Sting”.','a11');
pushNotif('approval','“Bright Mornings — Final Cut” was approved as Final Output.','a9');
...
DB.auditLog.push(
  {id:'au3',by:'Priya Fernandez',action:'Revision',entity:'Trailer — Theme Sting',detail:'Requested revision on v1',date:'2026-08-17T14:40:00'},
  {id:'au4',by:'Priya Fernandez',action:'Approval',entity:'Bright Mornings — Final Cut',detail:'Approved v1 as FINAL',date:'2026-08-19T16:10:00'},
);
...
DB.webhooks.push(
  {id:'w1', endpoint:'https://hooks.beeproduction.studio/asset-approved', status:200, payload:'{"asset":"Bright Mornings — Final Cut","event":"final_output_approved"}', date:'2026-08-19T16:10:02'}
);