...
function pageArchitecture(){
  return `
    ...
    <div class="section-sub">How BEE PRODUCTION is put together, and why — for the project write-up.</div>

    <div class="card" style="padding:22px;margin-top:16px;">
      <h3 style="margin-top:0;">Architecture style: Layered Architecture</h3>
      <p style="color:var(--text-dim);font-size:13.5px;line-height:1.6;">BEE PRODUCTION is organized in three layers. The <b>presentation layer</b> is this interface — navigation, forms, and views that render the current state. The <b>business logic layer</b> is the <span class="mono">Studio</span> object: it owns the rules for submissions, review decisions, workflow automation, and integrations, and it's the only place those rules live. The <b>data layer</b> is the in-memory <span class="mono">DB</span> store that stands in for a production database (projects, assets, versions, comments, notifications, audit log, events).</p>
